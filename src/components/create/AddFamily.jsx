...
const AddFamily = ({funcCloseTap, prpsName, prpsType}) => {
    const dispatch = useDispatch()
    const userId = useSelector(selectUserId)
    const [loading, setLoading] = useState(false)
    //const [type, setType] = useState(prpsType)
    ...
    const addFamilyUser = async (e) => {
        //setLoading(true)
        e.preventDefault()
        try {
            const docRef = await addDoc(collection(dbFireStore, `${prpsType}`), {
                primary: false,
                firstname: firstName,
                lastname: lastName,
                birthday: born,
    ...
    return (
        <div className="form-add-family">
            <div className="container pt-3">
                <h2 className="text-center">แบบฟอร์มกรอกข้อมูลบุคคลในครอบครัว</h2>
                
                <div className="form-personal-data-add my-4">
                    
                    <form onSubmit={addFamilyUser}>
                        ...
                        <div className="section-a">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" placeholder="09XXXXXXXX" id="input-tel" onChange={onChangeTel} style={{appearance: 'none', margin: '0'}} />
                                </div>
                                <div className="col-sm-6">
                        ...
                        <div className="section-g">
                            <div className="row">
                                <div className="col-sm-7 mb-1">
                                    ...
                                    <select id="relation-with-user" className="form-select" onChange={onChangeRelation} required >
                            ...
                            <div className="row">
                                <div className="col-sm-7 mb-1">
                                    <div className="form-check mx-2">
                                        <input type="checkbox" id="are-you-student" className="form-check-input" onChange={onChangeStudent} />
                                        <label htmlFor="are-you-student" className="form-label" >เป็นนักเรียนของโรงเรียนเพลินพัฒนาหรือไม่</label>
                                    </div>
                                    <div className="student-pptn-section row d-none">
                                        <div className="col-sm-6">
                                            <label htmlFor="class-level" className="form-label mx-2">ชั้น</label>
                                            <select id="class-level" className="form-select" onChange={onChangeClassLevel}>
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <select id="room-level" className="form-select" onChange={onChangeRoomLevel}>
